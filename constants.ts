...
// API Configuration - use environment variable, empty string = same-origin (relative)
...
export const FIXED_QUERIES = {
  ...
  // Contractors
  "Which waybills are assigned to VENDOR-A?": true,
...
export const QUERY_CATEGORIES: CategoryData[] = [
  ...
  },
  {
    ...
    icon: Users,
    queries: [
      "Which waybills are assigned to VENDOR-A?",
